...
const VerifyOtpPage = lazy(() => import('./pages/Public/VerifyOtpPage/VerifyOtpPage'));
const ForgotPasswordPage = lazy(() => import('./pages/Public/ForgotPasswordPage/ForgotPasswordPage'));
const ResetPasswordPage = lazy(() => import('./pages/Public/ResetPasswordPage/ResetPasswordPage'));
    ...
    <Suspense fallback={<Loading />}>
      <Router>
        <Switch>
          ...
          <WithLayoutRoute
            exact
            path="/movie/:id/cinemas"
            layout={PublicLayout}
            layoutProps={{ withFooter: false }}
            component={SelectCinemaPage}
          />
          <WithLayoutRoute
            exact
            path="/movie/:id"
