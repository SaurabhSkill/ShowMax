...
class BookingPage extends Component {
  ...
  async checkout(paymentResult = null) {
    ...
    // Legacy checkout without payment (for backward compatibility)
...
const mapStateToProps = (
  ...
  // Filter showtimes by the selected movie ID (from selectedShowtime or selectedMovie)
  showtimes: showtimeState.showtimes.filter(showtime => {
    const movieIdFromShowtime = (typeof showtime.movieId === 'object') ? showtime.movieId._id : showtime.movieId;
    const selectedMovieId = movieState.selectedMovie ? movieState.selectedMovie._id : null;
    return selectedMovieId ? movieIdFromShowtime === selectedMovieId : true;
  }),
