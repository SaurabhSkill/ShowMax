...
export const getShowtimesByMovie = movieId => async dispatch => {
  try {
...
export const getShowtimeById = showtimeId => async dispatch => {
  try {
...
export const getShowtimesByCinema = cinemaId => async dispatch => {
  try {
